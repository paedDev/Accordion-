...
const TictTactToe = () => {
    ...
    function Square({ value, onClick }) {
        return <button className='border border-red-600 text-4xl h-20 text-center w-20  bg-gray-100  justify-center items-center flex flex-col' onClick={onClick}>{value}</button>
    }
